    ...
    <div style="background-image: url('img/breadcrumb-gradient-bg.png');height: 250px;display: block;">
        <div class="container">
            <div class="row justify-content-center" style="margin-top: 90px;">
                 <div class="text-center row">
                        ...
                        <h1 style="margin-left:5%;"><strong>scRNA-seq Data Statistics</strong></h1>
                </div>
            </div>
        </div>
    </div>
      ...
      <section style="margin-top:120px;">
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
                <%@include file="statistics_contents.jsp" %>
            </div>
    </section>
 <%@include file="footer.jsp" %>
</div>   
<script src="https://cdn.bootcdn.net/ajax/libs/echarts/5.4.2/echarts.min.js"></script>
<script src="echarts/echarts_statistics.js"></script>
 ...
 var myChart1_1 = echarts.init(document.getElementById('container-1_1'));
        ...
        var options_getdata = {
            ...
            success: function () {
                ...
                option1.title.text = "Cell number in Primary site";
                ...
                option1.title.text = "Cell number in Meatastatic site";
