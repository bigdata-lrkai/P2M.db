...
grid: {
    top: '3%', // 设置图表距离容器顶部的距离
    bottom: '0%', // 设置图表距离容器底部的距离
    left: '25%', // 设置图表距离容器左边的距离
    right: '15%', // 设置图表距离容器右边的距离
    height: '80%',
    containLabel: false
},
  ...
  xAxis: {
    ...
    name: 'Sender cells', // X 轴注释
    nameLocation: 'end', // 注释位置
    nameGap: 5, // 注释与轴之间的间隔
    nameTextStyle: {
  ...
  visualMap: {
    type: 'continuous', // 设置为连续型 visualMap
    min: 0,
    max: 3,
    precision:2,
    calculable: true,
    clickable: true,
//    padding: [100, 20, 10, 20], // 上、右、下、左的内边距值
//    orient: 'horizontal',
    orient: 'vertical',
    right: '4%',
    bottom: '65%'
...
// 假设有两个不同的连接属性
var linksAttr1 = [
//    { source: 'Node 1', target: 'Node 2', value: 0.1, color: 'blue',curveness:0.3 },
//    { source: 'Node 2', target: 'Node 3', value: 0.6, color: 'blue',curveness:0.3 },

    // 其他连接关系...
];

var linksAttr2 = [
//    { source: 'Node 1', target: 'Node 3', value: 0.3,  color: 'red',curveness:0.3 },
//    { source: 'Node 2', target: 'Node 3', value: 0.4,  color: 'red' ,curveness:0.3 },
    // 其他连接关系...
];

var linksAttr = [
//    { source: 'Node 1', target: 'Node 3', value: 0.3,  color: 'red',curveness:0.3 },
//    { source: 'Node 2', target: 'Node 3', value: 0.4,  color: 'red',curveness:0.5 },
//    { source: 'Node 1', target: 'Node 2', value: 0.1, color: 'blue',curveness:0.3 },
//    { source: 'Node 2', target: 'Node 3', value: 0.6, color: 'blue',curveness:0.3 },
...
var circular_option_middle = {
    // 设置标题
    title: {
//        text: 'Circos Chart',
//        subtext: 'Example Circos Chart'
    },
    // 设置 tooltip
    tooltip: {},
    // 设置 legend
