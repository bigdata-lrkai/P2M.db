...
<div class="help">
    <div class="help-container">
        <ul id="nav" class="help-nav">
            <li class="current"><a class="btn" href="#c1">Sample Number<br> Distribution</a></li>
        ...
        <div class="help-content">
            <section id="c1">
                <h4 style="color:#181e3f;font-weight:bold;">Sample Number Distribution</h4>
                <div class="content">   
            ...
            <section id="c2" style="height:1300px;">
                <h4 style="color:#181e3f;font-weight:bold;margin-top: 3%;">Immune Cell Distribution</h4>
                <div class="content">
